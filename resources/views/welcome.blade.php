...
<body class="bg-[#FDFDFC] text-[#1b1b18] min-h-screen flex flex-col">
    ...
    <!-- Navbar -->
    <Navbar class="sticky top-0 z-50 w-full px-6 py-4 shadow bg-white/30 backdrop-blur-md">
    ...
    <main
        ...
        <div class="flex flex-col-reverse items-center px-6 mx-auto max-w-7xl lg:flex-row">
            ...
            <div class="flex justify-center w-full mb-10 lg:w-2/5 lg:mb-0">
                <img src="{{ asset('image/Hero_read.png') }}" alt="Hero Image"
    ...
    <div class="relative py-10 bg-gray-50">
        <div
            class="flex flex-col items-center justify-between gap-10 px-6 mx-auto max-w-7xl md:flex-row md:items-center">
            <!-- Bagian Kiri: Gambar -->
            <div class="w-full md:w-1/2">
